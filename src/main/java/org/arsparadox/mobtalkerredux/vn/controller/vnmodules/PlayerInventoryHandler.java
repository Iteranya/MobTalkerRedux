...
//
//import com.example.mobtalkerredux.MobTalkerRedux;
...
//            if (!stack.isEmpty()) {
//                String itemId = Objects.requireNonNull(MobTalkerRedux.RegistryEvents.ITEMS.getRegistryKey(stack.getItem())).toString();
